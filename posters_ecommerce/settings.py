"""
Django settings for posters_ecommerce project.
...
SECRET_KEY = 'django-insecure-(b)j%!@7g$5n+yh6ty9vqy0frb@-(984!4$lp1*=#5*+sqvpb$'
...
LOGIN_URL = '/login/'
LOGIN_REDIRECT_URL = '/'
WSGI_APPLICATION = 'posters_ecommerce.wsgi.application'
...
if 'DEVELOPMENT' in os.environ:
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    DEFAULT_FROM_EMAIL = 'soulpowerposters@example.com'
else:
